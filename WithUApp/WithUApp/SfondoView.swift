...
//CONOSCENDO LE TONALITA' DI ROSSO, VERDE E BLU SI PUO' ANCHE FARE CON UNA SEMPLICE RIGA DEL TIPO
// -> Color(red: 0.2, green: 0.4, blue: 0.6) => SCOMODO
...
struct ContentView: View {
    @State private var isAnimating = false
        var body: some View {
            VStack {
             /*  Image(systemName: "mustache.fill") //immagine
                    .resizable()
